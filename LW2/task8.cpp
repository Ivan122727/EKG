...
static void RenderSceneCB() {
	...
	Matrix4f Scaling;
	Scaling.m[0][0] = Scale; Scaling.m[0][1] = 0.0f;   Scaling.m[0][2] = 0.0f;        Scaling.m[0][3] = 0.0f;
	Scaling.m[1][0] = 0.0f;  Scaling.m[1][1] = Scale;  Scaling.m[1][2] = 0.0f;        Scaling.m[1][3] = 0.0f;
	Scaling.m[2][0] = 0.0f;  Scaling.m[2][1] = 0.0f;   Scaling.m[2][2] = Scale;       Scaling.m[2][3] = 0.0f;
	Scaling.m[3][0] = 0.0f;  Scaling.m[3][1] = 0.0f;   Scaling.m[3][2] = 0.0f;        Scaling.m[3][3] = 1.0f;

	//World = Translation * Scaling;
	World = Scaling;

	glUniformMatrix4fv(gWorldLocation8, 1, GL_TRUE, &World.m[0][0]);
...
static void CompileShaders() {
	...
	gWorldLocation8 = glGetUniformLocation(ShaderProgram, "gWorld");
	assert(gWorldLocation8 != 0xFFFFFFFF);
}

void invoke8(int argc, char** argv) {
	glutInit(&argc, argv);
